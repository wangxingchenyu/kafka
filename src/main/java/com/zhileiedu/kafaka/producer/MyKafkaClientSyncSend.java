 ...
 * @Date: 2020/3/4 14:45
 */
public class MyKafkaClientSyncSend {
	...
	public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
		...
		for (int i = 0; i < 5; i++) {
			...
			//logger.info("执行了发送...........");
			Future<RecordMetadata> metadataFuture = kafkaProducer.send(new ProducerRecord<String, String>("second", Integer.toString(i), "value" + i));

			// 获取里面的数据,future对象不会报null
